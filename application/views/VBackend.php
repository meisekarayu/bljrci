...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="temp/index2.html" class="logo">
      ...
      <span class="logo-lg"><b>PDBI</b> - SI</span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
		...
		<li><a href=""><a href="<?php echo site_url('Welcome/DataKelas'); ?>"><i class="fa fa-book"></i> <span>Data Kelas</span></a></li>
		<li><a href=""><a href="<?php echo site_url('Welcome/DataJadwal'); ?>"><i class="fa fa-book"></i> <span>Data Jadwal</span></a></li>
		

        <li class="header">LABELS</li>
        <li><a href="<?php echo site_url('Welcome/Logout'); ?>">Logout</a><i class="fa fa-circle-o text-red"></i> <span>Logout</span></a></li>
      </ul>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <small>Information System Management</small>
      </h1>
      <ol class="breadcrumb">
